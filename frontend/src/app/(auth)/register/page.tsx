...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden bg-slate-950">
      {/* Background Orbs */}
      <div className="bg-orb bg-orb-indigo w-[500px] h-[500px] -top-40 right-0 opacity-60" />
      <div className="bg-orb bg-orb-purple w-[400px] h-[400px] bottom-0 -left-20 opacity-40" />
      <div className="bg-orb bg-orb-pink w-[300px] h-[300px] top-1/3 left-1/4 opacity-15" />
      ...
      <div className="w-full max-w-lg space-y-8 relative z-10 animate-fade-in-up">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-1.5">
            <h2 className="text-3xl font-black text-white font-outfit tracking-tight">Start Your Evolution</h2>
            <p className="text-slate-600 text-sm font-medium max-w-xs mx-auto">Join the elite network of engineers building the next generation of tech.</p>
          </div>
        </div>
        ...
        <Card className="p-8 border-white/[0.06] relative" hoverable={false}>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1">Professional Identity</label>
              <Input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1">Sync Email</label>
              <Input 
                type="email" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1">Access Credential</label>
              <Input 
                type="password" 
                ...
                className="h-12"
              />
              <p className="text-[10px] text-slate-700 font-medium ml-1">Min. 8 characters with specialized symbols recommended</p>
            </div>
        ...
        <p className="text-center text-sm font-medium text-slate-600">
          Already a Lead?{' '}
          <Link href="/login" className="text-indigo-400 font-bold hover:text-white transition-colors">
            Resume Access →
          </Link>
        </p>
      </div>
